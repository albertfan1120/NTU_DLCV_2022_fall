...
class CLIPScore:
    ...
    def __call__(self, predictions, images_root):
        ...
        """
        total_score = 0.
        for img_name, pred_caption in tqdm(predictions.items()):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred_file", default="output.json")
    parser.add_argument("--images_root", default="/home/albert/DLCV/HW3/hw3_data/p2_data/images/val/", help="Image root")
    parser.add_argument("--annotation_file", default="/home/albert/DLCV/HW3/hw3_data/p2_data/val.json", help="Annotation json file")
